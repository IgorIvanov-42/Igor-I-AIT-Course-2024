package classWork.time_api_exercisses;
...
public class TimeAppl {
    public static void main(String[] args) {
        ...
        // задаем locale
        df = DateTimeFormatter.ofPattern("dd M yyyy", Locale.ITALIAN);
        date = gagarin.format(df);
        System.out.println(date);
        ...
        LocalDate result = LocalDate.parse(stringDate, DateTimeFormatter.ofPattern("[dd:MM:yyyy][dd/MM/yyyy]"));
        System.out.println(result);// ISO format

        System.out.println("-------------------");

        String dianaBirthday = "23.06.1983";
        LocalDate dianaBirt = LocalDate.parse(dianaBirthday, DateTimeFormatter.ofPattern("[dd.MM.yyyy]"));
