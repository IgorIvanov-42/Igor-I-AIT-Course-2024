package classWork.carStream;
//- Перебор всех элементов carList с помощью forEach()
// и вывод их в консоль
//- Перебор всех элементов с выполнением некоторой
// операции над каждым элементом списка и вывод их в консоль:
...
public class CarStreamAppl {
    public static void main(String[] args) {
        ...
        System.out.println("---Cars sorted by age, brand, color---");
        List<CarStream> carsSorted = sortCarsByAgeBrandColor(cars);
    ...
    private static List<CarStream> sortCarsByAgeBrandColor(List<CarStream> cars) {
        return cars.stream()
