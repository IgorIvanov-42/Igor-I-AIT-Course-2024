...
//  - создаем несколько конструкторов под разные
//  нужды (это иллюстрация полиморфизма)
//  - реализуем метод display() и display(String greeting)
//  (это еще одна иллюстрация полиморфизма)
